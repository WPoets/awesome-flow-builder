...
// Apply this filter in your theme's functions.php or a custom functionality plugin
add_filter('acf/blocks/default_block_version', function ($default_version, $block) {
    return 3;
}, 10, 2);
